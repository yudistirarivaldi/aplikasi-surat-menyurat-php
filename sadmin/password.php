...
if (isset($_POST["submit"])) {
    ...
    if (password_verify($password, $row_user["password"])) {
        ...
        $password2 = mysqli_escape_string($conn, $_POST["konfirmasiPassword"]);

        if ($password1 !== $password2) {
            echo "<script>
            alert('Ubah passwotd GAGAL, Konfirmasi password tidak sama..!');
            history.go(-1);
            </script>";
            return false;
        } else {
        ...
        echo "<script>
            alert('Ubah passwor GAGAL, password lama tidak cocok..!');
            history.go(-1);
            </script>";
        return false;
    }
